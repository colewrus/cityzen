...
public class TriggerScript : MonoBehaviour {
	...
	//private float Com;
	public GameObject CommunityCircle;
	...
	void Update()
	{
		CommunityCircle.transform.localScale = new Vector3 (radius *2, .001f, radius *2);
	}
